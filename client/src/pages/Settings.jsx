      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-700 lg:col-span-2">
          <h3 className="font-bold text-gray-200 mb-4 flex items-center gap-2">
            <Bot size={20} className="text-green-400" /> AI Behavior (System Prompt)
          </h3>
          <p className="text-sm text-gray-400 mb-2">Define how the AI should behave, its persona, and rules.</p>
          <textarea
            value={settings.system_prompt}
            onChange={(e) => handleChange('system_prompt', e.target.value)}
            className="w-full bg-gray-900 border border-gray-700 text-white rounded-lg p-4 h-40 font-mono text-sm focus:outline-none focus:border-green-500"
          />
        </div>
